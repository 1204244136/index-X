...
X系列以台版为本体，在其基础上与网译版进行校对（后期可能会改变），部分卷会对照日文原版扫图校对格式。
...
## 各种问题及回复
```
Q1：为什么有的以台版为基础，有的以网翻为基础？
A1：以网翻为基础是因为没有台版，如果台版出了会重做。
Q2：稳定版和最新版有什么区别？
A2：稳定版在反馈群下载，不更新，大部分阅读器都能看。
    最新版在官网（此界面）下载，持续更新，只推荐用支持epub3的阅读器观看。
    稳定版和最新版并不是X系列的两个分支，稳定版可以被视为X系列的一个历史版本。
```
