...
- ✅ 画集／纯图册源（整本没有正文文本页、全为整页图片，如「はいむらきよたか画集４　ＲＥＢＩＲＴＨ」）**整本跳过**并打印理由：不改写、不分配表头、不重命名图片、不合并分页、不写产物；只有显式 `--force-image-only` 才强制走文本管线
