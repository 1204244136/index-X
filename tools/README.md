...
2026-02-14 对日文「大画面」62 处锚点（其中 60 处有中文配对）统一 18 处写法，统一后 60 处中文全部为「大屏幕」。
...
2026-09-12 统一 178 处、涉及 75 个中文文件：术语层 169 处（サイド→阵营，含 1 处译反修正、1 处错字、1 处脱字）、指示层回落 9 处（側 被误升格为阵营）。统一后 `check_side_terms.py` 归零，`check_alignment.py --strict` 913 个正文文件 0 问题。
