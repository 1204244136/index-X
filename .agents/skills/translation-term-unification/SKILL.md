...
| `proofread-adjudication-unifications-2026-09-21.md`（第四轮） | `暴発` 是作者伞词（创约3 `S3_03-08:933/934` 自己把"炸膛"与"走火"都列入其定义），中文按语境分写 走火／炸膛／崩了／暴乱，**不作统一**；只清不成立的用词（如"暴发"）。与 `空中分解` 同属"按语义分轨"一类 |
| `imagination-term-unification-2026-09-23.md` | 异形词统一：规范「想象」淘汰「想像」；排除「想·像这样」等合法句式 |
| `variant-words-unification-2026-09-23.md` | 全库淘汰异形词残留收敛：规划（淘汰规画）、身份（淘汰身分）、震撼（淘汰震憾）、坐镇（淘汰坐阵） |
